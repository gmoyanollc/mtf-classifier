...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="varNamespace">
        ...
        <Namespace prefix="mtflocation" schemaLocation="mtfLocation.xsd"
            >urn:mtf:mil:6040b:ensit:B.1.01.12:location</Namespace><!-- 1 -->
        <Namespace prefix="mtfentity" schemaLocation="mtfEntity.xsd"
            >urn:mtf:mil:6040b:ensit:B.1.01.12:entity</Namespace><!-- 2 -->
        <Namespace prefix="mtfactivity" schemaLocation="mtfActivity.xsd"
            >urn:mtf:mil:6040b:ensit:B.1.01.12:activity</Namespace><!-- 3 -->
...
<!--    <xsl:variable name="varDocumentUri6040Messages">
    ...
    <xsl:template match="*:schema">
        <xsl:copy copy-namespaces="no">
            ...
            <!--<xsl:apply-templates select="//*:element[contains(@name, 'Location')]"/>
            <xsl:apply-templates select="//*:complexType[contains(@name, 'Location')]"/>-->
